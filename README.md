...
- Preview: https://main--eds-dropins--rgvenky.hlx.page/
- Live: https://main--eds-dropins--rgvenky.hlx.live/
...
1. Open the `eds-dropins` directory in your favorite IDE and start coding :)
